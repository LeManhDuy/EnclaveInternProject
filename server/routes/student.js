...
// @access Private
router.post("/:teacherID&:parentID", verifyJWTandTeacher, upload.single("student_image"), async (req, res) => {
...
router.put("/:id", verifyJWTandTeacher, upload.single("student_image"), async (req, res) => {
    const {
        student_fullname,
        student_dateofbirth,
        student_gender,
