...
router.get('/add-subjects-to-grade-and-student/:subjectID&:gradeID&:studentID', async (req, res) => {
    ...
    try {
        ...
        if (result) {
            return res.status(400).json({ success: false, message: 'This student is in this subject' })
        }
        ...
        // })
        return res.json({
            success: true, message: 'Add student to subject successfully', subject_name: subject.subject_name,
            subject_ratio: subject.subject_ratio, grade_id: gradeID, grade_name: grade.grade_name,
...
router.get('/get-subject-by-id/:studentID', async (req, res) => {
    ...
    try {
        ...
        console.log(student)
        return res.status(200).json({ student_name: student.student_fullname, subjects: student.subjects })
    } catch (error) {
